...
python2.7 bi_lstm_cnn.py --fine_tune --embedding glove --oov embedding --update momentum --batch_size 10 --num_units 100 --num_filters 20 --learning_rate 0.1 --decay_rate 0.1 --grad_clipping 3 --regular none --dropout  --train "data/conll/Essay_Level/train.dat" --dev "data/conll/Essay_Level/dev.dat" --test "data/conll/Essay_Level/test.dat" --embedding_dict "data/glove.6B.100d.gz" --output_prediction --patience 5